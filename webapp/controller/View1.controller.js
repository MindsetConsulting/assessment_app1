sap.ui.define(
    ...
    function (Controller, JSONModel, MessageToast, MessageBox, ResponsiveFlowLayoutData, Input, Filter, FilterOperator) {
        ...
        var oDataModel;
        return Controller.extend("com.mindset.assessmentapp1.controller.View1", {
        ...
        onSearch: function (oEvent) {
            ...
            data = data.filter((item) => {
            return aSelectedKeys.includes(item.draft.toString(), 0) && item.title.toLowerCase().includes(title.toLowerCase());
            })
