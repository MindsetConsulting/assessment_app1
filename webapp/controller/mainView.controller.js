sap.ui.define(
  ...
  function (Controller, JSONModel, MessageToast, MessageBox, UI5Date, ResponsiveFlowLayoutData, Input, History, Filter, FilterOperator, DateFormat) {
    ...
    var oDataModel;
    let index;
    return Controller.extend("com.mindset.assessmentapp1.controller.mainView", {
      ...
      onInit: async function () {
        ...
        this.byId('WizardStep2')._oNextButton.setProperty('text', 'Step 3');
        // var token = {			
        //   "csrfToken" : ""
        //   };
        ...
        // var tokenurl = 'https://mindsetbtpdev.authentication.us10.hana.ondemand.com/oauth/token?grant_type=password_credentials&response_type=token';

        // var clientID = 'sb-quizapp!t37789';
        // var clientSecret = '0h/4FqX7PaRfN0lYqBFGwOfStr4=';
        ...
        //     tokenModel["csrfToken"] = data.access_token; //request.getResponseHeader('X-Csrf-Token');
        //     },
        //   error: function(err) {
        //     console.log(err);
        //   }
      ...
      getDialog: function () {
        ...
        if (!this.dialog) {
          ...
          this.dialog = sap.ui.xmlfragment("idFragment", "com.mindset.assessmentapp1.fragments.AddQuestion", this);
          //debugger;
