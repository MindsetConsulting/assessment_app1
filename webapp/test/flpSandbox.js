		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#commindsetassessmentapp1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commindsetassessmentapp1-display": {
								"semanticObject": "commindsetassessmentapp1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mindset.assessmentapp1",
									"url": sap.ui.require.toUrl("com/mindset/assessmentapp1")
								}
							}
						}
					}
